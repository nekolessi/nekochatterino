...
#define MyAppName "Neko's Chatterino"
#define MyAppVersion "2.5.5"
#define MyAppPublisher "nekolessi"
#define MyAppURL "https://github.com/nekolessi/nekochatterino"
...
AppId={{15C5A85B-2D33-4FD8-965F-55B76A9E3948}
AppName={#MyAppName}
...
#else
OutputBaseFilename=NekoChatterino.Installer
#endif
Compression=lzma
...
[Icons]
Name: "{autoprograms}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; AppUserModelID: "nekolessi.NekoChatterino"
Name: "{autodesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; AppUserModelID: "nekolessi.NekoChatterino"; Tasks: desktopicon
